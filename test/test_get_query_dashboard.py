...
import get_query_dashboard as get_query_dashboard


class test_get_query_dashboard(unittest.TestCase):
    ...
    def test_lambda_handler_happy_path(self, mock_create_engine, mock_select):
        ...
        with mock.patch.dict(
            get_query_dashboard.os.environ, {"Database_Location": "MyPostgresDatase"}
        ):
            with mock.patch("get_query_dashboard.alchemy_functions") as mock_alchemy_functions:
